...
import wolvrine from "../assets/wolvrine.mp4"
...
const Soon2 = () => {
    ...
    return(
        ...
        <video className='emma  img-fluid mt-5 rounded' src={wolvrine} loop controls/>
        
        <div className='text-light mt-3'>
        <h3>Deadpool X wolvrine</h3>
